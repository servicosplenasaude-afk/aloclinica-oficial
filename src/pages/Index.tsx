...
import doctorTeleconsultaAsset from "@/assets/medica-pingo-teleconsulta.png.asset.json";
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              <img src={doctorTeleconsultaAsset.url} alt="Médica e o mascote Pingo mostrando uma teleconsulta no celular" className="public-image-depth relative z-10 w-[380px] lg:w-[540px] h-auto drop-shadow-2xl" loading="lazy" />
            </motion.div>
