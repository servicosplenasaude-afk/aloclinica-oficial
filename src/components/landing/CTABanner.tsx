              ...
              >
                {BADGES.map((item, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="group inline-flex items-center gap-2 pl-2 pr-3.5 py-2 rounded-full bg-white/[0.06] border border-white/10 hover:bg-white/[0.12] hover:border-white/20 transition-colors"
                    >
                      <span className={`inline-flex items-center justify-center w-6 h-6 rounded-full bg-white/10 ring-1 ${color}`}>
                        <Icon className="w-3 h-3" strokeWidth={2.5} />
                      </span>
                      <span className="text-white/90 font-bold text-[10px] md:text-xs uppercase tracking-wider">
                        {item.label}
                      </span>
                    </div>
                  );
