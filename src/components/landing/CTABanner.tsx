              ...
              >
                {BADGES.map((item, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="group inline-flex items-center gap-1.5 md:gap-2 shrink-0 pl-1.5 pr-2.5 md:pl-2 md:pr-3.5 py-1.5 md:py-2 rounded-full bg-white/[0.06] border border-white/10 hover:bg-white/[0.12] hover:border-white/20 transition-colors"
                    >
                      <span className={`inline-flex items-center justify-center w-5 h-5 md:w-6 md:h-6 rounded-full bg-white/10 ring-1 ${color}`}>
                        <Icon className="w-2.5 h-2.5 md:w-3 md:h-3" strokeWidth={2.5} />
                      </span>
                      <span className="text-white/90 font-bold text-[9px] md:text-[11px] uppercase tracking-wider whitespace-nowrap">
                        {item.label}
                      </span>
                    </div>
                  );
