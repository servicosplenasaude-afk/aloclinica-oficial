              ...
              >
                {BADGES.map((item, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="group inline-flex items-center gap-1.5 shrink-0 pl-1.5 pr-2 md:pl-2 md:pr-2.5 py-1.5 md:py-2 rounded-full bg-white/[0.06] border border-white/10 hover:bg-white/[0.12] hover:border-white/20 transition-colors"
                    >
                      ...
                      <span className="text-white/90 font-bold text-[8px] md:text-[10px] uppercase tracking-wider whitespace-nowrap">
                        {item.label}
                      </span>
                    </div>
                  );
